    ...
    <span
      className={cn(
        "inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium",
        {
          ...
          "bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300": variant === "amber",
          "bg-purple-100 text-purple-800 dark:bg-purple-900/40 dark:text-purple-300": variant === "purple",
